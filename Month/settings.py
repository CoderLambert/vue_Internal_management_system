...
SECRET_KEY = '6q5+i#-8s*5twvtm!kojhe*l2$x43_l1@ghwu1f^rm0ksr0jg8'
...
MIDDLEWARE = [
    ...
    'utils.myMiddleware.DisableCSRFCheck',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, "app_front/dist"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Month.wsgi.application'
